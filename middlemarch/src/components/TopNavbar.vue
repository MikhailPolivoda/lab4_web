  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link px-2">Подробнее</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Цены</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Частые вопрос</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">О компании</a></li>
      </ul>
